...
const token = '5609551872:AAGemBgvq3SE1hmwLJyrZpMIIZ6nmbr81XQ';

var chatId = -853139651;
...
(async () => {
  ...
  let p = 'https://oddsportal.com/matches/tennis'

  await page.goto('https://oddsportal.com/matches/tennis');
  ...
  for (let l = 0; l < links.length; l++) {
    ...
    if (res.length > 50 & res.startsWith('/tennis/') & !res.includes("inplay")) {
      try {
