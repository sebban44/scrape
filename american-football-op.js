...
const token = '5858722387:AAGbL-NasgxdB4KqhEZaMczbpnK7EfF55R0';

var chatId = -861617969;
...
(async () => {
  ...
  let p = 'https://oddsportal.com/matches/american-football'

  await page.goto('https://oddsportal.com/matches/american-football');
  ...
  for (let l = 0; l < links.length; l++) {
    let res = links[l];
    if (res.length > 50 & res.startsWith('/american-football/') & !res.includes("inplay")) {
      try {
